...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ergodox(  // QWERTY persistent layer
        ...
        TT(_FN), KC_N, KC_M, TD(TD_PC), KC_DOT,  KC_SLSH,  KC_RSFT,
                            TT(_SIMBOLOS), TT(_FN), _______, KC_RALT, KC_RCTRL,
                                    KC_RALT, KC_RCTRL,
        KC_INS,
...
/* SIMBOLOS : Simbolos2
    ...
    [_SIMBOLOS] = LAYOUT_ergodox(
        ...
        _______, TD(TD_PAC), ES_ASTR, ES_PLUS, ES_AT, ES_BSLS, _______,
        _______, TD(TD_LLA), TD(TD_PAR), ES_SLSH, ES_AMPR, ES_PIPE,
        _______, TD(TD_INT), TD(TD_EXC), TD(TD_ANG), KC_SLSH, ES_HASH, _______,
